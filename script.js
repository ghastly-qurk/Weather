...
<h2 class='my-3 py-3 display-2 font-weight-lighter'><img src='http://openweathermap.org/img/wn/${weather.weather[0].icon}@2x.png' height='50' width='50' />${+((weather.main.temp - 273.15).toFixed(1))}°C</h2>
